...
@property (weak) IBOutlet NSTextView *headerField;
@property (weak) IBOutlet HeaderController *headerVC;
@property (weak) IBOutlet NSViewController *bodyVC;
@end
...
- (IBAction)generateClassFile:(id)sender {
    ...
    _modelHelper.isSaveToFile = NO;
    BOOL generaFileSuccess = [_modelHelper createModelWithJson:_jsonField.string];
    _headerField.string = _modelHelper.headerString;
    NSAlert *alert = [[NSAlert alloc] init];
    ...
    NSSplitViewController *split = (NSSplitViewController*)self.parentViewController;
    HeaderController *headerVC = (HeaderController *)split.splitViewItems[1].viewController;
    ImplentController *bodyVC = (ImplentController*)split.splitViewItems[2].viewController;
    headerVC.headerField.string = _modelHelper.headerString;
    bodyVC.implentField.string = _modelHelper.sourceString;
}
